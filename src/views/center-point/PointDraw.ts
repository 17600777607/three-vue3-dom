...
export class PointDraw {
   ...
   */
  initRenderer = () => {
    console.log('PointDraw类----初始化渲染容器')
   ...
   **/
  initControls = () => {
    console.log('PointDraw类----初始化用户交互')
  ...
  initCSSRender(dom: string) {
    console.log('PointDraw类--创建文字渲染器 CSS2DRenderer')
  ...
  create2DObject(val: TextObjType) {
    console.log('PointDraw类--创建 CSS2DObject  dom')
